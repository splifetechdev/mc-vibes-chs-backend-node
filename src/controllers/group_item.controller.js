...
exports.getAll = async (req, res) =>
  res.json(await GroupItemService.findAll(req.params.id));

exports.getAllByID = async (req, res) =>
  res.json(await GroupItemService.findAllByID(req.params.id));

exports.getListAll = async (req, res) => {
  var tmpObject = [];

  const res_position = await GroupItemService.findListAll();
...
exports.getListByCompany = async (req, res) => {
  ...
  const res_position = await GroupItemService.findListByCompany(
...
exports.getAlldata = async (req, res) =>
  res.json(await GroupItemService.getAlldata());

exports.create = async (req, res) =>
  res.json(await GroupItemService.create(req.body));

exports.update = async (req, res) => {
  try {
    res
      .status(201)
      .json(await GroupItemService.update(req.params.id, req.body));
  } catch (error) {
...
exports.getAlldatabycompany = async (req, res) =>
  res.json(await GroupItemService.getAlldatabycompany(req.params.id));

exports.delete = async (req, res) => {
  res.json(await GroupItemService.delete(req.params.id));
};
