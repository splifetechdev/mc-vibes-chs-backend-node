...
exports.getAll = async (req, res) =>
  res.json(await ItemTypeService.findAll(req.params.id));

exports.getAllByID = async (req, res) =>
  res.json(await ItemTypeService.findAllByID(req.params.id));

exports.getListAll = async (req, res) => {
  var tmpObject = [];

  const res_position = await ItemTypeService.findListAll();
...
exports.getListByCompany = async (req, res) => {
  ...
  const res_position = await ItemTypeService.findListByCompany(
...
exports.getAlldata = async (req, res) =>
  res.json(await ItemTypeService.getAlldata());

exports.create = async (req, res) =>
  res.json(await ItemTypeService.create(req.body));

exports.update = async (req, res) => {
  try {
    res
      .status(201)
      .json(await ItemTypeService.update(req.params.id, req.body));
  } catch (error) {
...
exports.getAlldatabycompany = async (req, res) =>
  res.json(await ItemTypeService.getAlldatabycompany(req.params.id));

exports.delete = async (req, res) => {
  res.json(await ItemTypeService.delete(req.params.id));
};
