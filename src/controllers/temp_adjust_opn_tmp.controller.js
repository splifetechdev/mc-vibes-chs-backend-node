...
exports.getAll = async (req, res) =>
  res.json(await AdjustTempOpnTmpService.findAll(req.params.id));

exports.getAllByID = async (req, res) =>
  res.json(await AdjustTempOpnTmpService.findAllByID(req.params.id));

exports.getListAll = async (req, res) => {
  var tmpObject = [];

  const res_position = await AdjustTempOpnTmpService.findListAll();
...
exports.getListByCompany = async (req, res) => {
  ...
  const res_position = await AdjustTempOpnTmpService.findListByCompany(
...
exports.getAlldata = async (req, res) =>
  res.json(await AdjustTempOpnTmpService.getAlldata());
...
exports.TestData = async (req, res) => {
  ...
  // await AdjustTempOpnTmpService.findALLByRouting(
  //   doc_running,
  //   rtg_id,
  //   item_master_id
  // );
...
exports.create = async (req, res) =>
  res.json(await AdjustTempOpnTmpService.create(req.body));

exports.update = async (req, res) => {
  try {
    res
      .status(201)
      .json(await AdjustTempOpnTmpService.update(req.params.id, req.body));
  } catch (error) {
...
exports.getAlldatabycompany = async (req, res) =>
  res.json(await AdjustTempOpnTmpService.getAlldatabycompany(req.params.id));

exports.delete = async (req, res) => {
  res.json(await AdjustTempOpnTmpService.delete(req.params.id));
};
