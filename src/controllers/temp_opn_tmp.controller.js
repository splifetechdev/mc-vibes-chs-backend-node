const TempOpnTmpService = require("../services/temp_opn_tmp.service");
const doc_runningService = require("../services/doc_running.service");

exports.getAll = async (req, res) =>
  res.json(await TempOpnTmpService.findAll(req.params.id));

exports.getAllByID = async (req, res) =>
  res.json(await TempOpnTmpService.findAllByID(req.params.id));

exports.getListAll = async (req, res) => {
  var tmpObject = [];

  const res_position = await TempOpnTmpService.findListAll();
...
exports.getListByCompany = async (req, res) => {
  ...
  const res_position = await TempOpnTmpService.findListByCompany(
...
exports.getAlldata = async (req, res) =>
  res.json(await TempOpnTmpService.getAlldata());
...
exports.TestData = async (req, res) => {
  ...
  // await TempOpnTmpService.findALLByRouting(
  //   doc_running,
  //   rtg_id,
  //   item_master_id
  // );
...
exports.create = async (req, res) =>
  res.json(await TempOpnTmpService.create(req.body));

exports.update = async (req, res) => {
  try {
    res
      .status(201)
      .json(await TempOpnTmpService.update(req.params.id, req.body));
  } catch (error) {
...
exports.getAlldatabycompany = async (req, res) =>
  res.json(await TempOpnTmpService.getAlldatabycompany(req.params.id));

exports.delete = async (req, res) => {
  res.json(await TempOpnTmpService.delete(req.params.id));
};
